  ...
  return (
    <>
      ...
      <div className="page-wrapper">
        ...
        {/* 8.5 WhatsApp community band */}
        {whatsappLink && (
          <section className="wa-band container" id="whatsapp">
            <div className="wa-band__card tilt-card" data-tilt="3">
              <div className="specular-sheen"></div>
              <div className="wa-band__icon">
                <WaIcon size={34} />
              </div>
              <div className="wa-band__text">
                <h3>Join our free WhatsApp community</h3>
                <p>
                  AI updates, workshop dates, and curated resources — straight
                  to WhatsApp. Free, no spam, leave anytime.
                </p>
              </div>
              <a
                href={whatsappLink}
                ...
                rel="noopener noreferrer"
                className="btn-wa"
                onClick={() => track({ name: "whatsapp_join_click", props: { source: "home_band" } })}
              >
                <WaIcon size={20} /> Join on WhatsApp →
              </a>
            </div>
          </section>
        )}
      ...
      {whatsappLink && (
        <a
          ...
          rel="noopener noreferrer"
          className="wa-float"
          aria-label="Join our free WhatsApp community"
          title="Join our free WhatsApp community"
          onClick={() => track({ name: "whatsapp_join_click", props: { source: "float_button" } })}
        >
          <WaIcon size={30} />
        </a>
      )}
